...
<section class="content-header">
	<h1><?php echo $title; ?> | <?php echo $tgl_awal; ?> s.d. <?php echo $tgl_akhir; ?> | <?php echo $struk; ?></h1>
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="box box-success">
		<div class="box-header">
			<div class="row">
				<div class="col-md-6">
					...
					<a href="<?=base_url();?>kasir/export_excel/<?php echo $tgl_awal; ?>/<?php echo $tgl_akhir; ?>/<?php echo $no_struk; ?>">
		...
		<div class="box-body table-responsive padding">
			<table id="mydatapenjualancari" class="table table-bordered table-hover dataTable no-footer" style="text-align: center">
				<thead>
				<tr>
				...
				<tbody id="show_data_penjualan_cari">
...
<script type="text/javascript">
	$(document).ready(function(){
		tampil_data_penjualan_cari();

		//fungsi tampil data Penjualan
		function tampil_data_penjualan_cari(){
			var tgl_awal = '<?php echo $tgl_awal; ?>';
			var tgl_akhir = '<?php echo $tgl_akhir; ?>';
			var no_struk = '<?php echo $no_struk; ?>';
			$.ajax({
				url : '<?=base_url();?>kasir/dataPenjualanCari/'+tgl_awal+'/'+tgl_akhir+'/'+no_struk,
				type : 'GET',
				async : true,
				dataType : 'json',
				success : function(data){
					...
					if (data.response != null) {
						html += '<tr><td colspan="10"><button class="btn btn-danger form-control">'+data.response+'</button></td></tr>';
						$('#show_data_penjualan_cari').html(html);
		...
		$('.modal').on('hidden.bs.modal', function () {
			tampil_data_penjualan_cari(refreshPage(),1000);
		});


		//GET HAPUS
		$('#show_data_penjualan_cari').on('click','.hapus_data',function(){
		...
		$('#btn_hapus').on('click',function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					tampil_data_penjualan_cari(refreshPage(),1000); //fungsi refresh
				}
			});
			return false;
		});
