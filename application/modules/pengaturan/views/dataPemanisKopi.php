...
<section class="content">
	...
	<div class="box box-success">
		<div class="box-header">
			<div class="row">
				<div class="col-md-6">
					<button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambahdata">Tambah Pemanis Kopi</button>
				</div>
			</div>
		...
		<div class="box-body table-responsive padding">
			<table id="mydatapemaniskopi" class="table table-bordered table-hover dataTable no-footer" style="text-align: center">
				<thead>
				<tr>
				...
				<tbody id="show_data_pemanis_kopi">
...
<script type="text/javascript">
	$(document).ready(function(){
		tampil_data_pemanis_kopi();


		//fungsi tampil data pemanis kopi
		function tampil_data_pemanis_kopi(){
			$.ajax({
				url : '<?=base_url();?>pengaturan/data_pemanis_kopi',
				type : 'GET',
				async : true,
				dataType : 'json',
				success : function(data){
					...
					for(i=0; i<data.length; i++){
						...
						html += '<tr>'+
							...
							'<a href="javascript:;" class="btn btn-primary edit_data" data="'+data[i].id_pemanis_kopi+'"><i class="fa fa-edit"></i></a>'+
							'</td>'+
							'<td style="text-align:center;">'+
							'<a href="javascript:;" class="btn btn-danger hapus_data" data="'+data[i].id_pemanis_kopi+'"><i class="fa fa-close"></i></a>'+
							'</td>'+
							'</tr>';
					}
					$('#show_data_pemanis_kopi').html(html);
					$('#mydatapemaniskopi').DataTable({
						retrieve: true,
						paging: true,
						searching: true
					});
